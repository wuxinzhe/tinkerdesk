 ...
 *
 * 复刻 showing-agent service/prompt 包的全部 15 个模块。
 */
...
export {AgentModePromptModule} from './agent-mode-prompt-module'
export type {IDynamicPromptModule, PromptContext} from '../types'
